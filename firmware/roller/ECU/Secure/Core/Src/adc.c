...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  */
    ...
    PB1     ------> ADC1_INP5
    */
    GPIO_InitStruct.Pin = OIL_LEVEL_ADC_Pin|OIL_TEMP_ADC_Pin|WATER_LEVEL_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TEMP_SENSOR_1_ADC_Pin|TEMP_SENSOR_2_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ENGINE_SENSOR_ADC_Pin|VBAT_12V_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PA6     ------> ADC2_INP3
    */
    GPIO_InitStruct.Pin = FWD_VALVE_CURR_ADC_Pin|REV_VALVE_CURR_ADC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_INP5
    */
    HAL_GPIO_DeInit(GPIOC, OIL_LEVEL_ADC_Pin|OIL_TEMP_ADC_Pin|WATER_LEVEL_ADC_Pin);

    HAL_GPIO_DeInit(GPIOA, TEMP_SENSOR_1_ADC_Pin|TEMP_SENSOR_2_ADC_Pin);

    HAL_GPIO_DeInit(GPIOB, ENGINE_SENSOR_ADC_Pin|VBAT_12V_ADC_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_INP3
    */
    HAL_GPIO_DeInit(GPIOA, FWD_VALVE_CURR_ADC_Pin|REV_VALVE_CURR_ADC_Pin);
