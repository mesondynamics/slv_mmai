...
task_boot_image="${ECU_LEGACY_RELEASE_OPEN_IMAGE:-${task_project_dir}/Bootloader/OEMiROT/build/ReleaseOpen/ECU_OEMiROT.bin}"
task_closed_boot_image="${ECU_LEGACY_RELEASE_CLOSED_IMAGE:-${task_project_dir}/Bootloader/OEMiROT/build/ReleaseClosed/ECU_OEMiROT.bin}"
